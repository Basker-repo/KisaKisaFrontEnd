...
const axios = require('axios');
  ...
  class Bussiness extends React.Component {
    ...
    componentDidMount(){
      ...
      if(this.props.location.state != undefined){
        ...
        self.setState({blockchain_data1:blockchain_data1,blockchain_data2:blockchain_data1,blockchain_data3:blockchain_data1,blockchain_data4:blockchain_data1},()=>{
          console.log(self.state.blockchain_data1);
         })
      }else{

          var self = this;
          axios.get('http://kisakisa-1041517533.eu-central-1.elb.amazonaws.com/products') 
          .then(function (response) {
            ...
            self.setState({startup_1:startup_1,startup_2:startup_1,startup_3:startup_1,stories_2:startup_1,startup_1,startup_4:startup_1,startup_5: startup_1,lengthOfSilder:lengthOfData},()=>{
  ...
  render(){
    if(this.props.location.state != undefined) {
      return (<div>
        ...
        <div className="row">
                ...
                <div className="container-fluid">
                    ...
                    <div className="container-fluid">
                        <h3 style={{color: "black"}}>Saudi Arabia launches special residency scheme for expats </h3>
                        <h5>More stories</h5>
                ...
                <div className="container-fluid">
                    <h4 style={{color: "black"}}>More from <span style={{color: "#008080"}}>startups</span>   </h4>
                ...
                <div className="container-fluid">
                        <h4 style={{color: "black"}}>More from <span style={{color: "#808080"}}>others</span>  </h4>
     ...
     <div className= "col-md-2 vertical"></div> 
  ...
  <div className="col-md-5">
      ...
      <div class = "horizontal-dotter-line-2"></div>
    ...
    {this.state.startup_3.length > 0  ?
        ...
        <div class = "horizontal-line-1"></div> 
          ...
          {this.state.startup_5.length > 0  && this.state.startup_5.map((val,idx) => {
          return(
          idx <= this.state.lengthOfSilder
          ?
